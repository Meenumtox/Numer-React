...
const Bisection =()=>{
    ...
    axios.get('http://localhost:5000/numer')
        .then(res => {
            let data = res.data;
            setEquation(data[0].fx)
            setXL(data[0].XL)
            setXR(data[0].XR)
        })   
    const print = () =>{
